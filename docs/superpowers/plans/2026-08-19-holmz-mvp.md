...
```bash
go mod tidy
GOOS=windows GOARCH=amd64 CGO_ENABLED=0 go build -tags desktop,production -o /tmp/claude-1000/-home-g9bon-project-holmz-schedule-manager/783f16d5-792a-4ecb-8d8e-d4179db335f9/scratchpad/holmz.exe ./cmd/holmz
```
